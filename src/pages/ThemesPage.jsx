...
const SAMPLE={
  ...
  description:'Commercial Customer Web theme with iOS system typography, Platform-governed Phosphor and custom-image navigation, merchant-safe Navigation, Button, Forms/Input, Product Card, Typography and Commerce Surface Composers with renderer-backed choices.',
  ...
  manifest:{
    ...
    icons:{pack:'PHOSPHOR_NAV',active_style:'filled',inactive_style:'outline',size:24,allowed:PHOSPHOR_NAV,allow_custom_images:true,navigation_defaults:{home:'house',explore:'storefront',cart:'shopping-bag',orders:'receipt',profile:'user-circle'}},
  ...
  preview:{summary:'Luke Commerce iOS v1.7 adds Platform-approved custom PNG/WebP bottom-navigation artwork with optional Light/Dark variants while preserving the governed Phosphor catalog, all existing composers, Store Designer structure and required commerce flows. Merchants select icon keys only; arbitrary URLs, SVG and executable content remain prohibited.',figma_url:'',thumbnail_url:'',tags:['commerce','ios','mobile','phosphor','custom-icons','navigation-composer','button-composer','forms-composer','product-card-composer','typography-composer','commerce-surfaces','commercial']}
};
