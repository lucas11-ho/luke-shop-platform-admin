...
const SAMPLE={
  ...
  description:'Commercial Customer Web theme with iOS system typography, Platform-governed Phosphor navigation, merchant-safe Navigation, Button, Forms/Input, Product Card and Typography Composers, grouped commerce surfaces and renderer-backed choices.',
  ...
  preview:{summary:'Luke Commerce iOS v1.5 adds merchant-safe Product Card and Typography Composers to the governed Navigation, Button and Forms system: approved card layouts, image ratios, badges, price presentation, quick-add presentation, density, radius, elevation, font presets, role weights and text rhythm with no merchant CSS execution.',figma_url:'',thumbnail_url:'',tags:['commerce','ios','mobile','phosphor','navigation-composer','button-composer','forms-composer','product-card-composer','typography-composer','commercial','v1']}
};
